...
export function ProjectTabs({
  ...
  return (
    <Tabs value={TABS.includes(tab) ? tab : 'overview'} onValueChange={onTab}>
      ...
      <TabsContent value="tasks"><TasksTab projectId={id} tasks={detail.tasks} staff={staff} canEdit={canEdit} canReview={canReview} reviews={detail.taskReviews} activity={detail.activity} /></TabsContent>
